...
class TestLoggerUtil(unittest.TestCase):
    ...
    @patch(
        "Utils.LoggerUtil.json.load",
        return_value={"version": 1, "disable_existing_loggers": False},
    )
    ...
    def test_logger_initialization(
        ...
        mock_file_open.assert_called_once_with(
            "/Users/satwik/Documents/Satwik/Actionable-Item-Discovery/Utils/logging.json",
            "r",
        )
    ...
    @patch(
        "Utils.LoggerUtil.os.path.abspath",
        return_value="/Users/satwik/Documents/Satwik/Actionable-Item-Discovery/Utils/LoggerUtil.py",
    )
    ...
    @patch("Utils.LoggerUtil.logging.getLogger")
    @patch("builtins.open", new_callable=mock_open)
    def test_logger_initialization_create_logs_dir(
        self,
        mock_file_open,
        mock_getLogger,
        mock_dictConfig,
        ...
        mock_makedirs.assert_called_once_with(
            "/Users/satwik/Documents/Satwik/Actionable-Item-Discovery/Utils/../logs"
        )
        mock_dictConfig.assert_called_once_with(
            {"version": 1, "disable_existing_loggers": False}
        )
