...
class TestRandomForest(unittest.TestCase):
    ...
    def test_main(self):
        ...
        with patch.object(
            self.random_forest, "train_model", return_value=MagicMock()
        ) as mock_train_model, patch.object(
            self.random_forest, "test_model", return_value=self.y_pred
        ) as mock_test_model:
            ...
            self.random_forest.metrics.metrics.return_value = (
                mock_acc_score,
                mock_cr_report,
                mock_cnf_matrix,
            )

            result = self.random_forest.main(
            ...
            self.random_forest.metrics.metrics.assert_called_once_with(
