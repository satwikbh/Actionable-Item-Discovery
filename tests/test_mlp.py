...
class TestMLP(unittest.TestCase):
    ...
    def test_main(self):
        ...
        with patch.object(
            self.mlp, "train_model", return_value=MagicMock()
        ) as mock_train_model, patch.object(
            self.mlp, "test_model", return_value=self.y_pred
        ) as mock_test_model:
            ...
            self.mlp.metrics.metrics.return_value = (
                mock_acc_score,
                mock_cr_report,
                mock_cnf_matrix,
            )
            ...
            self.mlp.metrics.metrics.assert_called_once_with(
